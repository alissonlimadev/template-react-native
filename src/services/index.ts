export { default as Logs } from './logs/logs.service';
...
export { default as Sentry } from './sentry/sentry.service';
export { default as Storage } from './storage/storage.service';
